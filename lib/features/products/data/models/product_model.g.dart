...
const ProductModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.byte,
      enumMap: _ProductModelsyncStatusEnumValueMap,
    ),
...
ProductModel _productModelDeserialize(
  ...
  object.salePrice = reader.readDouble(offsets[6]);
  object.stockQuantity = reader.readLong(offsets[7]);
  object.syncStatus =
      _ProductModelsyncStatusValueEnumMap[reader.readByteOrNull(offsets[8])] ??
          SyncStatus.synced;
...
P _productModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 8:
      return (_ProductModelsyncStatusValueEnumMap[
...
const _ProductModelsyncStatusEnumValueMap = {
  'synced': 0,
  'pendingInsert': 1,
  'pendingUpdate': 2,
  'conflict': 3,
};
const _ProductModelsyncStatusValueEnumMap = {
  0: SyncStatus.synced,
...
extension ProductModelQueryWhereSort
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhere> anyLocalId() {
...
extension ProductModelQueryWhere
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> localIdEqualTo(
      Id localId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> localIdNotEqualTo(
      Id localId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> localIdLessThan(
      Id localId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> localIdBetween(
    Id lowerLocalId,
    Id upperLocalId, {
...
extension ProductModelQuerySortBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQuerySortThenBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByLocalId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'localId', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByLocalIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }
...
extension ProductModelQueryWhereDistinct
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct> distinctBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQueryProperty
  ...
  QueryBuilder<ProductModel, int, QQueryOperations> localIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, double, QQueryOperations> salePriceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, SyncStatus, QQueryOperations>
      syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
